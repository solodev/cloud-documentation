...
Token status can be changed by clicking on the round button.

Status active:

><img src="../../../images/api-tokens5.jpg" alt="api-tokens5.jpg" style="width: 40%; display: block"></a>

Status inactive:

><img src="../../../images/api-tokens6.jpg" alt="api-tokens6.jpg" style="width: 40%; display: block"></a>

## Add API token

Click on the "Add Token" blue button on the right to <a href="/profile/apitokens/add/">add</a> API token.

><img src="../../../images/api-tokens3.jpg" alt="api-tokens3.jpg" style="width: 40%; display: block"></a>

## Delete API token

Click on the "x" sign on the right to <a href="/profile/apitokens/delete/">delete</a> API token.

><img src="../../../images/api-delete.jpg" alt="api-delete.jpg" style="width: 100%; display: block"></a>
