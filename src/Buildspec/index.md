...
For example, users with a Marketplace Seller subscription can use Buildspec to customize their forms – allowing them to define the questions they need to ask buyers when configuring services in the Soldev Store. They can also use Buildspec to collect and pass values for various parameters in AWS CloudFormation Templates.
