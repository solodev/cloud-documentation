...
<div class="header">
  <div class="inner">
    ...
    <div>
      <h1>Bitcoin</h1>
      <p style="padding: 0 2rem; margin-bottom: 0;">The leading decentralized digital currency using blockchain technology for secure, <br>peer-to-peer transactions worldwide.</p>
    </div>
  </div>
