...
<div class="header">
  <div class="inner">
    ...
    <div>
      <h1>Litecoin</h1>
      <p style="padding-left: 2rem; margin-bottom: 0;">A peer-to-peer cryptocurrency offering faster transactions with an alternative blockchain hashing algorithm than Bitcoin.</p>
    </div>
  </div>
