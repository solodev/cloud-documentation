...
1. Navigate to your user in the left nav. 

<p><img src="/static/images/datadog/datadog-nav.jpg" alt="Datadog nav"></p>

2. Under **Organization settings**, click the API Keys tab.
<p><img src="/static/images/datadog/datadog-api-settings.jpg" alt="Datadog Organization settings"></p>

2. Click the **New Key** button.
<p><img src="/static/images/datadog/datadog-new-key.jpg" alt="Datadog New Key" style="width: 60%;"></p>

3. Enter a **name** for your key.

<p><img src="/static/images/datadog/datadog-new-key-name.jpg" alt="Datadog New Key Name" style="width: 60%;"></p>
