...
Adding a user to your org in Solodev Cloud is a simple process, and can be completed in minutes by following the steps below.
...
Search a group to add the new user to.

><img src="../../../images/users-add4.jpg" alt="users-add4" style="width: 60%; display: block"></a>
...
><img src="../../../images/users-add5.jpg" alt="users-add5" style="width: 60%; display: block"></a>

### Add

Once you’ve completed all of the fields, click the blue “Add” button and your user will be created.
