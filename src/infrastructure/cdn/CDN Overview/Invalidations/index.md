...
CDN Invalidations are presented in the form of a table with the details such as description, status, date of creation, and CDN creator. You can open the CDN Invalidation page by clicking it. 
